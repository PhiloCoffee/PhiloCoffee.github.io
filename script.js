const ARTICLES = {
  ...
  tech: [
    { date: "2026-05-23", titleEn: "How We Made a Tarot AI Toy in One Day", titleZh: "我们如何在一天内做出一个塔罗 AI 玩具", descriptionEn: "A workflow note on building PhiloCoffee Tarot Studio with AI-assisted images, static web design, mobile support, GitHub Pages, and homepage integration.", descriptionZh: "记录 PhiloCoffee Tarot Studio 的一天工作流：AI 图像、静态网页、手机适配、GitHub Pages 部署与社团主页联动。", href: "/tech/2026/0523_Tarot_AI_Toy/blog.md" },
